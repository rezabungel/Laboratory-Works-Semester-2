...
в виду, что массив отсортирован. Переопределите операцию добавления элемента (push)
...
int main()
{
	...
	MyArrayParent Massiv3;//Этот массив будем присваивать в 1ый.
